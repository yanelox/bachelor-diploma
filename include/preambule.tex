...
%% Работа с таблицами
\usepackage{array,tabularx,tabulary,booktabs,diagbox} % дополнительная работа с таблицами
...
%% TikZ
\usepackage{tikz}
\usetikzlibrary{graphs,graphs.standard,decorations.pathreplacing,shapes,arrows}
...
breaklines=true,
captionpos=b,
tabsize=4,          % количество пробелов на место табуляции
showtabs=false,     % скрыть символ табуляции
showstringspaces=false,
keepspaces=true     % сохранять пробелы и табы как есть
}
